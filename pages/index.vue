...
<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <template v-else>
      <h2 class="text-2xl font-bold mb-4">Pregunta {{ currentQuestionIndex + 1 }} de {{ questions.length }}</h2>
      <QuizQuestions
...
import QuizQuestions from '~/components/quizQuestions.vue';
 ...
 const {selectedModule, startQuiz, questions, currentQuestionIndex, score, currentQuestion, handleAnswer, quizCompleted, finishQuiz}= useQuiz()
</script>