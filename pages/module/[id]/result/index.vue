    ...
    <div class="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-[90%] lg:items-center">
      <div class="mx-auto max-w-3xl text-center">
        ...
        <div class="flex items-center justify-center bg-green-100 rounded-md my-5">
          ...
          <p>
            <span class="text-2xl font-medium text-green-600 pl-2">
              {{ score }} / {{ totalQuestions }} : {{ rightAnswersPercent }}%
            </span>
          </p>
        </div>
        <div class="flex items-center justify-center bg-red-100 rounded-md">
          <strong class="text-xl font-medium text-gray-500">
            Incorrectas :
          </strong>

          <p>
            <span class="text-2xl font-medium text-red-600 pl-2">
        ...
        <div class="mt-8 flex flex-wrap justify-center gap-4">
          <UButton class="px-12 mx-20 py-4" :to="`/module/${route.params.id}`"> Volver al Inicio </UButton>
        </div>
